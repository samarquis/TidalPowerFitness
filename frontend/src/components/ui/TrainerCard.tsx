        ...
        <div className="glass rounded-2xl overflow-hidden hover:bg-white/10 transition-all transform hover:scale-105 group">
            ...
            <div className="p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {trainer.specialties.slice(0, 3).map((specialty, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-1 bg-pacific-cyan/20 text-turquoise-surf rounded-full text-xs font-medium"
                                >
                                    {specialty}
                                </span>
                            ))}
                        ...
                        <div className="flex flex-wrap gap-2">
                            {trainer.certifications.slice(0, 2).map((cert, index) => (
                                <div key={index} className="flex items-center gap-1 text-xs text-gray-400">
                                    <svg className="w-4 h-4 text-turquoise-surf" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex gap-2 mt-6">
                    <Link
                        href="/contact"
                        className="flex-1 text-center px-4 py-3 bg-gradient-to-r from-cerulean to-pacific-cyan hover:from-dark-teal hover:to-dark-teal text-white font-semibold rounded-lg transition-all transform hover:scale-105"
                    >
                        Book Session
                    </Link>
