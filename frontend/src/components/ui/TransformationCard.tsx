    ...
    return (
        <div className="glass rounded-2xl overflow-hidden hover:bg-white/10 transition-all transform hover:scale-105">
            ...
            <div className="grid grid-cols-2 gap-1 bg-black">
                ...
                <div className="relative aspect-[3/4]">
                    <img
                        ...
                        className="w-full h-full object-cover"
                    />
                    <div className="absolute top-2 right-2 bg-gradient-to-r from-pacific-cyan to-turquoise-surf px-3 py-1 rounded-full text-sm font-semibold">
                        After
                    </div>
                </div>
            </div>
            ...
            <div className="p-6">
                ...
                <p className="text-turquoise-surf mb-4">{timeframe}</p>
