                ...
                {loading ? (
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredClients.map((client) => (
                            <div
                                key={client.id}
                                className="glass rounded-xl p-4 md:p-6 hover:bg-white/10 transition-all transform hover:scale-105"
                            >
                                {/* Avatar */}
                                <div className="flex items-center mb-4 min-w-0">
                                    <div className="w-12 h-12 md:w-16 md:h-16 shrink-0 rounded-full bg-gradient-to-br from-turquoise-surf to-cerulean flex items-center justify-center text-white text-xl md:text-2xl font-bold mr-3 md:mr-4">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-gray-400 text-xs md:text-sm truncate">{client.email}</p>
                                    </div>
                                </div>
