...
const adminLinks = [
    ...
    { title: 'Workout Templates', href: '/workouts/templates', icon: '📋', description: 'Manage reusable workout designs.' },
    { title: 'Leaderboards', href: '/leaderboard', icon: '🏆', description: 'View top performing clients and metrics.' },
    { title: 'Community Challenges', href: '/challenges', icon: '🎯', description: 'Manage and view active fitness challenges.' },
    { title: 'Exercise Library', href: '/exercises', icon: '📖', description: 'Browse and manage exercise database.' },
    ...
    { title: 'Reference Data', href: '/admin/reference-data', icon: '🗂️', description: 'Manage workout types, body parts, etc.' },
