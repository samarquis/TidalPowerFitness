...
When working with containerization docker best practices code, follow these standards and best practices:

**File patterns:** `**/Dockerfile,**/Dockerfile.*,**/*.dockerfile,**/docker-compose*.yml,**/docker-compose*.yaml`
