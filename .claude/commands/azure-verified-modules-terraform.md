...
When working with azure verified modules terraform code, follow these standards and best practices:

**File patterns:** `**/*.terraform, **/*.tf, **/*.tfvars, **/*.tfstate, **/*.tflint.hcl, **/*.tf.json, **/*.tfvars.json`
