...
When working with azure devops pipelines code, follow these standards and best practices:

**File patterns:** `**/azure-pipelines.yml, **/azure-pipelines*.yml, **/*.pipeline.yml`
