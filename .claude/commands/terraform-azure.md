...
When working with terraform azure code, follow these standards and best practices:

**File patterns:** `**/*.terraform, **/*.tf, **/*.tfvars, **/*.tflint.hcl, **/*.tfstate, **/*.tf.json, **/*.tfvars.json`
