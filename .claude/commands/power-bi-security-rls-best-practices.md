...
When working with power bi security rls best practices code, follow these standards and best practices:

**File patterns:** `**/*.{pbix,dax,md,txt,json,csharp,powershell}`
