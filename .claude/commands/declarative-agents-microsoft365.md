...
When working with declarative agents microsoft365 code, follow these standards and best practices:

**File patterns:** `**.json, **.ts, **.tsp, **manifest.json, **agent.json, **declarative-agent.json`
