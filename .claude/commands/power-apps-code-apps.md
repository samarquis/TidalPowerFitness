...
When working with power apps code apps code, follow these standards and best practices:

**File patterns:** `**/*.{ts,tsx,js,jsx}, **/vite.config.*, **/package.json, **/tsconfig.json, **/power.config.json`
