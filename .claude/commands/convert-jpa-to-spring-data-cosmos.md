...
When working with convert jpa to spring data cosmos code, follow these standards and best practices:

**File patterns:** `**/*.java,**/pom.xml,**/build.gradle,**/application*.properties`
