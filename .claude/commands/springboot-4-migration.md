...
When working with springboot 4 migration code, follow these standards and best practices:

**File patterns:** `**/*.java, **/*.kt, **/build.gradle.kts, **/build.gradle, **/settings.gradle.kts, **/gradle/libs.versions.toml, **/*.properties, **/*.yml, **/*.yaml`
