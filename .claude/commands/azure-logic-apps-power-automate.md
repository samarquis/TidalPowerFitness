...
When working with azure logic apps power automate code, follow these standards and best practices:

**File patterns:** `**/*.json,**/*.logicapp.json,**/workflow.json,**/*-definition.json,**/*.flow.json`
